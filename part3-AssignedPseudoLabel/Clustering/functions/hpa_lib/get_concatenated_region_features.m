function [features, imageids, feature_names, feature_computation_time, cell_regions , nuc_regions, skipimgs, slf_names] = get_concatenated_region_features(...
...
number_feature_sets = 1 %% modification

for feature_set_index = 1:number_feature_sets
%for feature_set_index = 1:number_feature_sets
    
%     if feature_set_index == 2 || feature_set_index == 5
%         continue;
%     end
...
%     end
    ...
    disp(feature_set_naming_conventions{feature_set_index})
    ...
    %whos feature*
    imgpathlist = data.imagelist;
end
disp('making feature matrix')
%features
imageids = get_imgids(image_path,imgpathlist);
