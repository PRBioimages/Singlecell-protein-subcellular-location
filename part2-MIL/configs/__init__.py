...
class Experiment(Element):
    def __init__(self, dict):
        ...
        self.run_fold = dict.get('run_fold', 1)
...
class Data(Element):
    def __init__(self, dict):
        ...
        self.data_root = dict.get('data_root', 'none')
...
class Train(Element):
    ...
    def __init__(self, dict):
        ...
        self.batch_size = dict.get('batch_size', 20)
        ...
        self.cutmix_prob = dict.get('cutmix_prob', 1)
...
class Loss(Element):
    def __init__(self, dict):
        ...
        self.pos_weight = dict.get('pos_weight', 1)
